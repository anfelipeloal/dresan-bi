...
async function handleSubmit({ data }) {
    try {
        ...
        // const monthsBetweenDate = useTransformDateCalculations().calculateMonthsBetweenDates({
        //     startDate: data.startDate,
        //     endDate: data.endDate,
        //     method: new SalesActivityProvider(),
        //     function: 'getSalesByBusinessUnit',
        // });

        const corporateProvider = new CorporateProvider();
        const dataSet = await corporateProvider.getSalesByBusinessUnit(data);
