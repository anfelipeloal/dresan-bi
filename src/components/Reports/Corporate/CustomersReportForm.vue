...
const props = defineProps({ isCorporateCustomers: String });
...
async function handleSubmit({ data }) {
    try {
        ...
        const dataSet = await (props.isCorporateCustomers ? corporateProvider.getCorporateCustomers(data) : corporateProvider.getTopCustomers(data));
